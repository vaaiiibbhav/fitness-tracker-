...
const AboutUs = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      image: "C:\Users\Vaibhav\fitness-tracker-\frontend\src\pages\charu.jpg",
      linkedin: "#",
      twitter: "#",
    },
    {
      ...
      image: "https://via.placeholder.com/300",
      linkedin: "https://www.linkedin.com/in/vaibhav-verma-905a1b270/",
      twitter: "#",
    },
    {
      name: "Anshuman Nayak",
    ...
    >
      <div className="container mx-auto px-4 py-16">
        ...
        >
          ...
          <div className="flex items-start">
            ...
            <p className="text-lg md:text-xl leading-relaxed text-gray-700">
              FitPal was founded in 2024 with a simple mission: to help
        ...
        >
          ...
          <p className="text-lg md:text-xl leading-relaxed text-gray-700">
            At FitPal, we're committed to empowering individuals to take
        ...
        >
          ...
          <p className="text-lg md:text-xl mb-8">
            ...
            the next level, FitPal is here to support you every step of the
